...
class Product(models.Model):
    ...
    image_dop1 = models.ImageField(upload_to='products/image/%Y/%m/%d', blank=True)
    image_dop2 = models.ImageField(upload_to='products/image/%Y/%m/%d', blank=True)
...
class Comment(models.Model):
    ...
    image_dop1 = models.ImageField(upload_to='comment_image/%Y/%m/%d', blank=True)
    image_dop2 = models.ImageField(upload_to='comment_image/%Y/%m/%d', blank=True)
